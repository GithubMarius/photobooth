...
from photobooth_settings            import black, white, num_keys, framerate, COM, lbl_choose_keys, up, down, right, left, space, t_disp, t_swipe, t_rand, t_move
...
while True:
    ...
    if x == t_rand*framerate and ticks_move_st == 0:
        ticks_move_st = pygame.time.get_ticks()
        ExtScreen.move_1 = 1
        ExtScreen.moved = 1
    elif pygame.time.get_ticks() >= ticks_move_st + t_move*1000 and ticks_move_st != 0:
        ticks_move_st = 0
        ExtScreen.move_1 = 0
        ExtScreen.moved = 1
    else:
